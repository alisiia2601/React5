...
const Home = () => {
  ...
  const onFrameContainer116Click = useCallback(() => {
    router.push("/");
  }, [router]);
    ...
    <div className={styles.home}>
      <div className={styles.background}>
        <div className={styles.frameParent}>
          ...
          <div className={styles.ellipseParent}>
            ...
            <img className={styles.frameChild} alt="" src="/ellipse-191.svg" />
            <img className={styles.frameChild} alt="" src="/ellipse-29.svg" />
          </div>
          <div className={styles.ellipseParent}>
            ...
            <img className={styles.frameChild} alt="" src="/ellipse-192.svg" />
            <img className={styles.frameChild} alt="" src="/ellipse-33.svg" />
          </div>
          <div className={styles.ellipseParent}>
            <img className={styles.frameChild} alt="" src="/ellipse-23.svg" />
      ...
      <div className={styles.footer}>
        ...
        <div className={styles.frameParent1}>
            ...
            <div className={styles.frameParent3}>
              <div className={styles.frameParent4}>
                <div className={styles.logoParent}>
                  ...
                  <div className={styles.elias}>Alisiia</div>
                </div>
                <a
          ...
          <div className={styles.copyright2022Made}>
            © Copyright 2022. Made by Alisiia
          </div>
        </div>
      </div>
      <div className={styles.contact}>
        <div className={styles.groupDiv}>
          ...
          <img className={styles.line7Stroke} alt="" src="/line-7-stroke.svg" />
        </div>
          ...
          <div className={styles.messageMeHereParent}>
            ...
            <div className={styles.instanceParent}>
              ...
              <div className={styles.discordParent}>
                ...
                <div className={styles.webDesignerAnd}>alisiia.ryzhykova@icloud.com</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className={styles.aboutMe}>
        <div className={styles.aboutMe1}>
          <div className={styles.helloImEliasContainer}>
            <p className={styles.helloImElias}>Hello, i’m Alisiia!</p>
            <p className={styles.helloImElias}>&nbsp;</p>
            <p
              className={styles.helloImElias}
            >{`I’m a self-taught front-end developer based in Stockholm, Sweden. I can develop responsive websites from scratch and raise them into modern user-friendly web experiences. `}</p>
            <p className={styles.helloImElias}>&nbsp;</p>
          ...
          <div className={styles.button}>
            <div className={styles.elias}>{`Read more ->`}</div>
          </div>
        </div>
      ...
      <div className={styles.skills}>
        ...
        <div className={styles.blockParent}>
          <div className={styles.block}>
            ...
            <div className={styles.frameParent9}>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>TypeScript</div>
                <div className={styles.webDesignerAnd}>Lua</div>
                <div className={styles.lua1}>Lua</div>
                <div className={styles.lua1}>Lua</div>
              </div>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>Python</div>
                <div className={styles.webDesignerAnd}>JavaScript</div>
          ...
          <div className={styles.frameParent10}>
            ...
            <div className={styles.frameParent9}>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>SQLite</div>
                <div className={styles.webDesignerAnd}>PostgreSQL</div>
                <div className={styles.lua1}>Lua</div>
                <div className={styles.lua1}>Lua</div>
              </div>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>Mongo</div>
          ...
          <div className={styles.frameParent12}>
            ...
            <div className={styles.frameParent9}>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>React</div>
                <div className={styles.webDesignerAnd}>Vue</div>
                <div className={styles.lua1}>Lua</div>
                <div className={styles.lua1}>Lua</div>
              </div>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>Disnake</div>
                <div className={styles.webDesignerAnd}>Discord.js</div>
                <div className={styles.lua1}>JavaScript</div>
              </div>
              <div className={styles.pythonParent5}>
                <div className={styles.webDesignerAnd}>Flask</div>
                <div className={styles.webDesignerAnd}>Express.js</div>
              </div>
              <div className={styles.pythonGroup}>
                <div className={styles.webDesignerAnd}>Python</div>
                <div className={styles.webDesignerAnd}>JavaScript</div>
          ...
          <div className={styles.frameParent14}>
            ...
            <div className={styles.frameParent9}>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>HTML</div>
                <div className={styles.webDesignerAnd}>CSS</div>
                <div className={styles.webDesignerAnd}>EJS</div>
                <div className={styles.webDesignerAnd}>SCSS</div>
              </div>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>REST</div>
                <div className={styles.webDesignerAnd}>Jinja</div>
                <div className={styles.lua1}>JavaScript</div>
              </div>
              <div className={styles.pythonGroup}>
                <div className={styles.webDesignerAnd}>Jinja</div>
          ...
          <div className={styles.frameParent16}>
            ...
            <div className={styles.frameParent9}>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>VSCode</div>
                <div className={styles.webDesignerAnd}>Neovim</div>
                <div className={styles.lua1}>Lua</div>
                <div className={styles.webDesignerAnd}>Linux</div>
              </div>
              <div className={styles.typescriptParent}>
                <div className={styles.webDesignerAnd}>Figma</div>
                <div className={styles.webDesignerAnd}>XFCE</div>
                <div className={styles.webDesignerAnd}>Arch</div>
              </div>
              <div className={styles.pythonParent5}>
                <div className={styles.webDesignerAnd}>Git</div>
                <div className={styles.webDesignerAnd}>Font Awesome</div>
              </div>
              <div className={styles.pythonGroup}>
                <div className={styles.webDesignerAnd}>Python</div>
                <div className={styles.webDesignerAnd}>JavaScript</div>
      ...
      <div className={styles.projects3}>
        <div className={styles.projectParent}>
            ...
            <div className={styles.chertnodesParent}>
              ...
              <div className={styles.instanceContainer}>
                <div className={styles.liveWrapper}>
                  <div className={styles.elias}>{`Live <~>`}</div>
                </div>
                <div className={styles.demoWrapper}>
                  <div className={styles.elias}>{`Cached >=`}</div>
                </div>
              </div>
            </div>
          </div>
          <div className={styles.rectangleParent}>
            ...
            <div className={styles.htmlParent}>
              <div className={styles.webDesignerAnd}>React</div>
              <div className={styles.webDesignerAnd}>Express</div>
              <div className={styles.webDesignerAnd}>Discord.js</div>
              <div className={styles.webDesignerAnd}>Node.js</div>
              <div className={styles.lua1}>Flask</div>
              <div className={styles.lua1}>Flask</div>
            </div>
            <div className={styles.htmlParent}>
      ...
      <div className={styles.first}>
        <div className={styles.eliasIsAWebDesignerAndFrParent}>
          ...
          <div className={styles.button1}>
            <div className={styles.elias}>Contact me!!</div>
          </div>
        </div>
      ...
      <div className={styles.quote}>
        ...
        <div className={styles.drWhoWrapper}>
          <div className={styles.webDesignerAnd}>- Dr. Who</div>
        </div>
      ...
      <div className={styles.header}>
        <div
          ...
          onClick={onFrameContainer116Click}
        >
          <div className={styles.logo}>
            <div className={styles.union}>
              <div className={styles.unionChild} />
          ...
          <b className={styles.webDesignerAnd}>Alisiia</b>
        </div>
        <div className={styles.headerLinkParent}>
          ...
          <div className={styles.parent}>
            <div className={styles.webDesignerAnd}>#</div>
            <div className={styles.home2}>works</div>
          </div>
          <div className={styles.parent}>
            <div className={styles.webDesignerAnd}>#</div>
          ...
          <div className={styles.parent}>
            <div className={styles.webDesignerAnd}>#</div>
            <div className={styles.home2}>contacts</div>
          </div>
          <div className={styles.languageSwitcher}>
            ...
            <div className={styles.ruParent}>
              <div className={styles.webDesignerAnd}>RU</div>
              <div className={styles.webDesignerAnd}>UA</div>
            </div>
          </div>
        </div>
      </div>
